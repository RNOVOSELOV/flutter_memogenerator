...
class AppColors {
  ...
  static final fuchsia16 = Color.fromRGBO(darkGrey.red, darkGrey.green, darkGrey.blue, 0.16);
  static final fuchsia38 = Color.fromRGBO(darkGrey.red, darkGrey.green, darkGrey.blue, 0.38);
